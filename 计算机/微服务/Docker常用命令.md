...
<span class="mark">$ docker exec-itmynginx_1 /bin/bash  
...
<td>RUN</td>
<td>创建镜像时要执行的命令</td>
<td>RUN pip install -r requirements.txt</td>
</tr>
<tr class="even">
<td>USER</td>
...
==\# 利用--driver或-d指定使用bridge驱动，创建mysite2-network网络$ docker network create –-driver bridge mysite2-network==
